...
@section('content')
                        ...
                        <nav>
                            <ul class="pagination">
                                ...
                                @if ($zona->hasMorePages())
                                    <li class="page-item"><a class="page-link"
                                            href="{{ $zona->nextPageUrl() }}">Lanjut</a></li>
                                @else
    ...
    <script>
        document.getElementById('perPageSelect').addEventListener('change', function() {
            ...
            window.location.href = "{{ route('zona.getZona', ['slug' => $zona->first()->slug ?? 'default-slug']) }}" + "?per_page=" + perPage + "&search=" + search;
        });
        ...
        document.getElementById('searchInput').addEventListener('keypress', function(e) {
            if (e.key === 'Enter') {
                ...
                window.location.href = "{{ route('zona.getZona', ['slug' => $zona->first()->slug ?? 'default-slug']) }}" + "?per_page=" + perPage + "&search=" +
                    search;
            }
        });
    </script>

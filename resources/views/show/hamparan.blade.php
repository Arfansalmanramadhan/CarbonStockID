            ...
            <div class="table-container paginated-table">
                <div class="table-header d-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <form method="GET"
                            action="{{ route('hamparan.getHamparan', ['id' => $zona->id ?? 'default-slug']) }}">
                            <div class="d-flex align-items-center">
                        ...
                        <button
                            onclick="window.location.href='{{ route('zona.getZona', ['slug' => $poltArea->slug]) }}'"
                            ...
                            @forelse ($hamparan as $index)
                                <tr class="data-row">
                                    ...
                                    <td class="hidden-column aksi-button">
                                        ...
                                        <form action="{{ route('hamparan.destroy', ['id' => $index->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')

                    ...
                    <div class="card-body-sup-plot">
                        ...
                        <form method="POST" action="{{ route('Semai.store') }}" id="SemaiForm">
                            ...
                            <div class="mb-3">
                                <label for="plotName" class="form-label">Total Berat Basah</label>
                                <input type="text" class="form-control" name="total_berat_basah"
                                    id="TotalBeratBasah" value="{{ $semai ? $semai->total_berat_basah : '' }}"
                                    placeholder="Masukkan total berat basah (gr)" />
                            </div>
                            <div class="mb-3">
                                <label for="plotName" class="form-label">Sample Berat Basah</label>
                                <input type="text" class="form-control" name="sample_berat_basah"
                                    id="SampleBeratBasah" value="{{ $semai ? $semai->sample_berat_basah : '' }}"
                                    placeholder="Masukkan sample berat basah (gr)" />
                            </div>
                            <div class="mb-3">
                                <label for="plotName" class="form-label">Sample Berat Kering</label>
                                <input type="text" class="form-control" name="sample_berat_kering"
                                    id="SampleBeratKering" value="{{ $semai ? $semai->sample_berat_kering : '' }}"
                                    placeholder="Masukkan sample berat kering (gr)" />
                            </div>
                            <div class="mb-3">
                                <label for="plotName" class="form-label">Total Berat Kering</label>
                                <input type="text" class="form-control-non" name="total_berat_kering"
                                    id="TotalBeratKering" value="{{ $semai ? $semai->kandungan_karbon : '' }}"
                                    readonly />
                            </div>
                    ...
                    <div class="card-body-sup-plot">
                        ...
                        <form method="POST" action="{{ route('tumbuhanBawah.store') }}" id="tumbuhanBawahForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="sample_berat_basah"
                                    id="SampleBeratBasah"
                                    value="{{ $tumbuhanbawah ? $tumbuhanbawah->sample_berat_basah : '' }}"
                                    placeholder="Masukkan sample berat basah (gr)" />
                            </div>
                            <div class="mb-3">
                                <label for="plotName" class="form-label">Sample Berat Kering</label>
                                <input type="text" class="form-control" name="sample_berat_kering"
                                    id="SampleBeratKering"
                                    value="{{ $tumbuhanbawah ? $tumbuhanbawah->sample_berat_kering : '' }}"
                                    placeholder="Masukkan sample berat kering (gr)" />
                            </div>
                            <div class="mb-3">
                                <label for="plotName" class="form-label">Total Berat Kering</label>
                        ...
                        <form method="POST" action="{{ route('tanah.store') }}" id="tanahForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="kedalaman_sample"
                                    id="KedalamanSample" value="{{ $tanah ? $tanah->kedalaman_sample : ' ' }} "
                                    placeholder="Masukkan kedalaman sample (cm)" />
                            </div>
                            <div class="mb-3">
                                <label for="plotName" class="form-label">Sample Berat Basah</label>
                                <input type="text" class="form-control" name="berat_jenis_tanah"
                                    id="SampleBeratBasah" value="{{ $tanah ? $tanah->berat_jenis_tanah : ' ' }} "
                                            ...
                                            <form method="POST" action="{{ route('pancang.store') }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-plot-b"
                                                        id="keliling"
                                                        value="{{ $pancang ? $pancang->keliling : '' }}"
                                                        name="keliling" />
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-container">
                                                        <input type="text" class="form-control form-control-plot-b"
                                                            id="namaLokal"
                                                            value="{{ $pancang ? $pancang->nama_lokal : '' }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-plot-b-non"
                                                        id="namaIlmiah"
                                                        value="{{ $pancang ? $pancang->nama_ilmiah : '' }}" readonly
                                                        name="nama_ilmiah" />
                                                </div>
                                            ...
                                            <form method="POST" action="{{ route('tiang.store') }}" id="tiangForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="diameter" value="{{ $tiang ? $tiang->diameter : ' ' }}"
                                                        readonly />
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('pohon.store') }}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-container">
                                                            <input type="text"
                                                                ...
                                                                id="namaLokal3"
                                                                value="{{ $pohon ? $pohon->nama_lokal : ' ' }}"
                                                                autocomplete="off" readonly name="nama_lokal" />
                                                            <img src="{{ asset('/images/ChevronUp.svg') }}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-plot-b"
                                                            id="namaIlmiah"
                                                            value="{{ $pohon ? $pohon->nama_ilmiah : ' ' }}" readonly
                                                            name="nama_ilmiah" />
                                                    </div>
                                                ...
                                                <form method="POST" action="{{ route('nekromas.store') }}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-plot-b"
                                                            ...
                                                            value="{{ $nekromas ? $nekromas->panjang : '' }} "
                                                            readonly />
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="BeratKayu" class="form-label">Berat Jenis
                                                            Kayu</label>
                                                        <input type="text" class="form-control form-control-plot-b"
                                                            id="BeratKayu" name="berat_jenis_kayu"
                                                            value="{{ $nekromas ? $nekromas->berat_jenis_kayu : '' }} "

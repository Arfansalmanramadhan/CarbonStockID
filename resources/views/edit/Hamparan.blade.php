        ...
        <div class="container-isi">
            <div class="card plot-info-card">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <dd></dd>
                    <form method="POST" action="{{ route('Hamparan.update', ['slugZ' => $zona->slug,'slugH' => $hamparan->slug]) }}" id="plotAreaForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select  form-control" aria-label="Default select example" name="nama_hamparan" value="{{ $hamparan->nama_hamparan }}">
                                <option selected value="{{ $hamparan->nama_hamparan }}">{{ $hamparan->nama_hamparan }}</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control-non" name="latitude" id="latitude"  value="{{ old('latitude', $hamparan->latitude) }}"  />
                        </div>
                        <div class="mb-4">
                            <label for="longitude" class="form-label">Longitude</label>
                            <input type="text" class="form-control-non" name="longitude" id="longitude"  value="{{ old('longitude', $hamparan->longitude) }}"/>
                        </div>
